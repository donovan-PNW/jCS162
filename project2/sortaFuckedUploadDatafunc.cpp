...
void searchByOrigin(vehicle entry[], int size);
void searchByMPG(vehicle entry[], int size);
...

{
    ...
    //displayList(entry, size);
    //cout << size << endl;
    //searchByOrigin(entry, size);
    searchByMPG(entry, size);
