...
set guicursor=n-v-c:block,o:hor50,i-ci:hor15,r-cr:hor30,sm:block,a:
set helplang=en
set hidden
set history=1000
set hlsearch
...
silent only
cd ~/jCS162/jProject3/implementation
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +363 oldVersion.cpp
badd +43 headers.h
badd +1 aDriver.cpp
badd +32 bTools.cpp
badd +1 ../video.h
...
badd +1 ../videolist.h
badd +76 ../video.cpp
badd +25 ../videolist.cpp
badd +1 ../driver.cpp
badd +1 ../tools.cpp
badd +127 carEntry.cpp
badd +1 video.cpp
badd +1 dCarsList.cpp
badd +131 dCarList.cpp
badd +2 bugnotes.txt
badd +0 zcars.txt
argglobal
silent! argdel *
$argadd oldVersion.cpp
set stal=2
edit bTools.cpp
...
exe 'vert 2resize ' . ((&columns * 61 + 106) / 212)
...
wincmd w
argglobal
if bufexists('aDriver.cpp') | buffer aDriver.cpp | else | edit aDriver.cpp | endif
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
wincmd w
argglobal
if bufexists('oldVersion.cpp') | buffer oldVersion.cpp | else | edit oldVersion.cpp | endif
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 262 - ((51 * winheight(0) + 26) / 52)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
262
...
wincmd w
argglobal
if bufexists('../tools.h') | buffer ../tools.h | else | edit ../tools.h | endif
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
exe 'vert 1resize ' . ((&columns * 58 + 106) / 212)
exe '2resize ' . ((&lines * 16 + 27) / 55)
exe 'vert 2resize ' . ((&columns * 58 + 106) / 212)
exe 'vert 3resize ' . ((&columns * 76 + 106) / 212)
exe 'vert 4resize ' . ((&columns * 76 + 106) / 212)
argglobal
setlocal keymap=
setlocal noarabic
setlocal autoindent
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 49 - ((6 * winheight(0) + 17) / 35)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
49
...
wincmd w
argglobal
if bufexists('../driver.cpp') | buffer ../driver.cpp | else | edit ../driver.cpp | endif
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 98 - ((0 * winheight(0) + 26) / 52)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
98
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 128 - ((49 * winheight(0) + 26) / 52)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
128
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 62 - ((31 * winheight(0) + 26) / 52)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
62
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 89 - ((46 * winheight(0) + 26) / 52)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
89
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 121 - ((0 * winheight(0) + 26) / 52)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
121
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 84 - ((51 * winheight(0) + 26) / 52)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
84
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 58 - ((50 * winheight(0) + 26) / 52)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
58
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 112 - ((33 * winheight(0) + 26) / 52)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
112
...
wincmd w
argglobal
if bufexists('dCarList.cpp') | buffer dCarList.cpp | else | edit dCarList.cpp | endif
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 174 - ((31 * winheight(0) + 26) / 52)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
174
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 81 - ((32 * winheight(0) + 26) / 52)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
81
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 339 - ((5 * winheight(0) + 26) / 52)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
339
