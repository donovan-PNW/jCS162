...
set shortmess=aoO
badd +101 carEntryList.cpp
badd +0 main.cpp
badd +0 tools.cpp
badd +0 ../videoList.cpp
badd +32 ../videolist.cpp
badd +73 ../tools.cpp
badd +16 ../driver.cpp
badd +0 cars.txt
argglobal
silent! argdel *
$argadd carEntryList.cpp
set stal=2
edit main.cpp
...
17
normal! zo
let s:l = 29 - ((25 * winheight(0) + 26) / 52)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
29
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 53 - ((28 * winheight(0) + 26) / 52)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
53
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 54 - ((18 * winheight(0) + 26) / 52)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
54
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 56 - ((51 * winheight(0) + 26) / 52)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
56
