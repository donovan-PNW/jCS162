...
silent only
cd ~/jCS162/3samplePrj3
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +1 driver.cpp
badd +1 ~/jCS162/samplePrj2/driver.cpp
badd +1 ~/jCS162/samplePrj2/tools.cpp
badd +1 tools.cpp
badd +1 video.cpp
...
$argadd driver.cpp
set stal=2
edit ~/jCS162/samplePrj2/driver.cpp
...
exe 'vert 1resize ' . ((&columns * 107 + 106) / 212)
exe 'vert 2resize ' . ((&columns * 104 + 106) / 212)
tabedit ~/jCS162/samplePrj2/tools.cpp
set splitbelow splitright
wincmd _ | wincmd |
vsplit
1wincmd h
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 85 - ((6 * winheight(0) + 26) / 52)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
85
