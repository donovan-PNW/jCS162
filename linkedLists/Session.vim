...
silent only
cd ~/jCS162/linkedLists
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +0 LinkedListSorted.cpp
badd +26 DoublyLinkedList.cpp
badd +0 LinkedListAtHead.cpp
badd +0 LinkedListAtTail.cpp
argglobal
silent! argdel *
$argadd LinkedListSorted.cpp
set stal=2
edit LinkedListSorted.cpp
...
wincmd w
argglobal
if bufexists('LinkedListSorted.cpp') | buffer LinkedListSorted.cpp | else | edit LinkedListSorted.cpp | endif
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 94 - ((42 * winheight(0) + 26) / 52)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
94
...
wincmd w
argglobal
if bufexists('LinkedListAtHead.cpp') | buffer LinkedListAtHead.cpp | else | edit LinkedListAtHead.cpp | endif
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 104 - ((51 * winheight(0) + 26) / 52)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
104
...
wincmd w
argglobal
if bufexists('DoublyLinkedList.cpp') | buffer DoublyLinkedList.cpp | else | edit DoublyLinkedList.cpp | endif
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
