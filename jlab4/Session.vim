...
badd +1 student.cpp
badd +1 student.h
badd +1 ../project3/main.cpp
badd +0 ../project3/implementation/main.cpp
badd +50 ../project3/implementation/carEntryList.cpp
badd +26 ../project3/implementation/carEntry.cpp
badd +38 ~/jCS162/project3/tools.cpp
badd +0 ../project3/implementation/headers.h
argglobal
silent! argdel *
$argadd app.cpp
set stal=2
...
wincmd w
argglobal
if bufexists('app.cpp') | buffer app.cpp | else | edit app.cpp | endif
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
wincmd w
argglobal
if bufexists('student.cpp') | buffer student.cpp | else | edit student.cpp | endif
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
exe 'vert 2resize ' . ((&columns * 106 + 106) / 212)
exe 'vert 3resize ' . ((&columns * 105 + 106) / 212)
tabedit ../project3/implementation/headers.h
set splitbelow splitright
wincmd _ | wincmd |
vsplit
1wincmd h
...
wincmd w
argglobal
if bufexists('../project3/implementation/carEntry.cpp') | buffer ../project3/implementation/carEntry.cpp | else | edit ../project3/implementation/carEntry.cpp | endif
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
